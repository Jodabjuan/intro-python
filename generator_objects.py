...
def main():
    ...
    print('The sum of the first 1 million square numbers is: ', sum(m_sq))
    print('The sum of the first 1 million square numbers is: ',
          sum(x*x for x in range(1, 1000001)))
    # the sum of the prime numbers between 1 and 10K
